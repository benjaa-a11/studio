    ...
    return (
        <div>
            <p
                ref={textRef}
                className={cn(
                    "text-foreground/80 leading-relaxed text-base max-w-3xl",
...
export default function MovieView({ movie, similarMovies }: MovieViewProps) {
  ...
  return (
    <div className="flex h-dvh w-full flex-col bg-background">
      <header className={cn(
        "flex h-16 shrink-0 items-center justify-between border-b px-4 md:px-6 pt-safe-top transition-opacity duration-300 z-10",
      ...
      <div className="flex-1 relative overflow-y-auto">
        ...
        <main className={cn("transition-opacity duration-300", showPlayer ? "opacity-0" : "opacity-100")}>
            ...
            <div className="container mx-auto p-4 md:p-6 space-y-6 -mt-16 sm:-mt-24 md:-mt-32 relative z-10">
                ...
                {movie.synopsis && <ExpandableText text={movie.synopsis} />}
