    ...
    return (
        <div className="relative w-full h-full">
            ...
            <div className={cn(
                ...
                <h2 
                    className="text-3xl md:text-5xl font-extrabold tracking-tighter text-white drop-shadow-xl"
                    style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.7)' }}
                >
                    {movie.title}
                </h2>
                <p 
                    className="max-w-xl text-white/90 text-sm md:text-base line-clamp-2 drop-shadow-lg"
                    style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)' }}
                >
                    {movie.synopsis}
                </p>
                <Button asChild size="lg" className="shadow-2xl shadow-primary/30">
